...
with st.expander("📚 Academic References (APA 7th Edition)"):
    ...
    2. **Hamka, A. A. M., Saleki, M., Nabavi, Z., & Dehghani, H. (2024).** Impacts of ammonium sulfate leaching on ion adsorption rare earths and soil mechanical properties. *Rudarsko-geološko-naftni zbornik*, 39(1), 21-34. https://doi.org/10.17794/rgn.2024.1.3
